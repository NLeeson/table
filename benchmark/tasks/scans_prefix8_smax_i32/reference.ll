...
entry:
  ...
  %c1 = icmp sgt i32 %v0, %v1
  %p1 = select i1 %c1, i32 %v0, i32 %v1
  %c2 = icmp sgt i32 %p1, %v2
  %p2 = select i1 %c2, i32 %p1, i32 %v2
  %c3 = icmp sgt i32 %p2, %v3
  %p3 = select i1 %c3, i32 %p2, i32 %v3
  %c4 = icmp sgt i32 %p3, %v4
  %p4 = select i1 %c4, i32 %p3, i32 %v4
  %c5 = icmp sgt i32 %p4, %v5
  %p5 = select i1 %c5, i32 %p4, i32 %v5
  %c6 = icmp sgt i32 %p5, %v6
  %p6 = select i1 %c6, i32 %p5, i32 %v6
  %c7 = icmp sgt i32 %p6, %v7
  %p7 = select i1 %c7, i32 %p6, i32 %v7
